<template>
  <main>
    ...
    <div @click ="showInfo = !showInfo" class="join__info__containerr">
  ...
  <ul>
    <li>Bitte den Host deiner Ideen-Sammel Session darum dich in die Session einzuladen. Du kannst über <strong>einen Einladungslink, den Session PIN</strong> oder durch Scannen eines <strong>QR Codes </strong>beitreten.</li>
  </ul>
</div>
</div>
